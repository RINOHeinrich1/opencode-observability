# 06 — Versioning de l.écosystème (v0.9.8)
...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.9.8` |
| `opencode-agents` | `~/.config/opencode/agent` | `0.6.4` |
| `opencode-notifier` | `~/.config/opencode/notifier` | `0.1.0` |
| `opencode-mcp-task-orchestrator` | `~/.config/opencode/mcp/task-orchestrator` | `0.8.11` |
...
| `opencode-scripts` | `~/.config/opencode/scripts` | `0.2.2` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.9.8** (2026-09-06,
Pré-vol E2E : spec absent → worktree temporaire (git)).
