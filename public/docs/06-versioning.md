...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.8.5` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.8.5** (2026-09-01,
Recette : titre court affiché + description longue en modale.
