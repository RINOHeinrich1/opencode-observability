# 06 — Versioning de l.écosystème (v0.9.3)
...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.9.3` |
| `opencode-agents` | `~/.config/opencode/agent` | `0.5.0` |
| `opencode-notifier` | `~/.config/opencode/notifier` | `0.1.0` |
| `opencode-mcp-task-orchestrator` | `~/.config/opencode/mcp/task-orchestrator` | `0.8.3` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.9.3** (2026-09-06,
Nettoyage specs E2E ONIRIA legacy + fix obsolescence e2e_sync_repo).
