...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.7.7` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.7.7** (2026-09-01,
Liste des tâches : groupement par recette.
