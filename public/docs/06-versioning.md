# 06 — Versioning de l.écosystème (v0.9.12)
...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.9.12` |
| `opencode-agents` | `~/.config/opencode/agent` | `0.6.5` |
| `opencode-notifier` | `~/.config/opencode/notifier` | `0.1.0` |
| `opencode-mcp-task-orchestrator` | `~/.config/opencode/mcp/task-orchestrator` | `0.8.15` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.9.12** (2026-09-06,
ADR 09 : Projets ⇄ Repos (N:N) + tâches multi-repos).
