...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.8.0` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.8.0** (2026-09-01,
Recette = objet de projet (titre, 0..N tâches) + titre/critère des tâches.
