...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.8.41` |
| `opencode-agents` | `~/.config/opencode/agent` | `0.4.12` |
| `opencode-notifier` | `~/.config/opencode/notifier` | `0.1.0` |
| `opencode-mcp-task-orchestrator` | `~/.config/opencode/mcp/task-orchestrator` | `0.7.2` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.8.41** (2026-09-04,
