...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.8.28` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.8.28** (2026-09-02,
Bouton « Session de la recette » : reprise systématique, plus de doublons.
