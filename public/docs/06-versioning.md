# 06 — Versioning de l.écosystème (v0.9.6)
...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.9.6` |
| `opencode-agents` | `~/.config/opencode/agent` | `0.6.2` |
| `opencode-notifier` | `~/.config/opencode/notifier` | `0.1.0` |
| `opencode-mcp-task-orchestrator` | `~/.config/opencode/mcp/task-orchestrator` | `0.8.8` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.9.6** (2026-09-06,
Run E2E asynchrone + module Secrets E2E).
