...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.8.9` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.8.9** (2026-09-01,
Modale recette : tâche couverte = titre + demande complète.
