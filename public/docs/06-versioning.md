...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.8.25` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.8.25** (2026-09-02,
Recette faite : bouton « Détail de la recette » — modal items lecture seule.
