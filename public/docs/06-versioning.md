...
|---|---|---|
| `opencode-observability` (panneau + docs) | `/root/orchestrator-panel` | `0.4.0` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.4.0** (2026-08-30,
Observabilité Phase 3 : qualité, rework, coût).
