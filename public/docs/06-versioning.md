# 06 — Versioning de l'écosystème (v0.6.0)
...
| `opencode-agents` | `~/.config/opencode/agent` | `0.2.0` |
...
Voir [CHANGELOG.md](CHANGELOG.md) — dernière entrée : **v0.6.0** (2026-08-31,
Tâches liées (associées) + nature de liaison.
